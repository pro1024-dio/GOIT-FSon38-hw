...
const authors = [
  ...
  const authorsInAlphabetOrder = [...authors].sort((firstEl, secondEl) => firstEl.localeCompare(secondEl));
  
  const authorsInReversedOrder = [...authors].sort((firstEl, secondEl) => secondEl.localeCompare(firstEl));